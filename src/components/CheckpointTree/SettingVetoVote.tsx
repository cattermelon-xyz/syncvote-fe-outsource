      ...
      <div className="flex flex-col gap-[32px] px-[24px] mb-[122px]">
        ...
        >
          ...
          >
            ...
            <p className="text-xl font-semibold">Veto</p>
          </div>
        ...
        <div className="flex flex-col gap-[16px]">
          <div className="flex flex-col w-full gap-[14px]">
            <div className="flex flex-col w-full gap-[6px]">
              <p className="flex text-text_1.5 font-medium text-grey-version-6">Option 1 </p>
              <input
                className="basic-info-input bg-[#E3E3E2]"
                type="text"
                value={defaultVotingDetail.listOfOptions[0].value}
                disabled
              />
            </div>
          </div>
...
export default SetUpUpVetoVote;
